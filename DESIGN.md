...
- **Rendering budget:** MeshStandardMaterial and additive textured planes only, no post-processing or bloom, shared vehicle geometry, instanced lane dashes, studs, posts and lamps, pixel ratio capped at 1.75 desktop and 1.5 phone, render loop stops when the hero leaves the viewport or the tab is hidden.
